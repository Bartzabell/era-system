...
// ── Tabs ───────────────────────────────────────────────────────────────────
type TabKey = 'priority' | 'verifying' | 'waiting' | 'assigned' | 'arriving' | 'resolved' | 'cancelled'
...
const tabColors: Record<TabKey, { dot: string; border: string; bg: string }> = {
    ...
    verifying: { dot: '#f592aa', border: '#f592aa', bg: '#f3f4f6' }, // soft amber
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <Modal :show="isFormVisible" @close="closeFormModal" class="fixed inset-0 z-50">
            <FormModal v-if="isFormVisible" :mode="formMode" :record="currentRecord" :barangays="barangays"
                ...
                :has-full-access="hasFullAccess" :current-user-id="currentUserId" @close="closeFormModal"
        ...
        <div class="w-full flex justify-center py-8 px-4">
            <div class="w-full max-w-7xl">
                ...
                <div class="flex items-center justify-between mb-7">
                    ...
                    <button @click="openCreateModal" class="inline-flex items-center gap-1.5 bg-gray-900 hover:bg-gray-700
                ...
                <div class="flex gap-0.5">
                    <button v-for="tab in tabs" :key="tab.key" @click="activeTab = tab.key" :style="activeTab === tab.key
                        ...
                        {{ tab.label }}
                        <span v-if="tab.key !== 'priority' && statusCounts[tab.key]" class="text-[11px] font-medium bg-gray-100 dark:bg-gray-700
                ...
                <div class="bg-white p-2 dark:bg-gray-900 rounded-b-lg rounded-tr-lg overflow-hidden transition-colors"
                    ...
                    <DataTable :columns="columns" :data="filteredData" :show-per-page="true" :filters="localFilters"
