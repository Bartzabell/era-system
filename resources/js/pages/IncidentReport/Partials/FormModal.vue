                ...
                <div class="grid grid-cols-1 gap-3 p-3 mb-4 border border-dashed border-gray-400 lg:grid-cols-2">
                    ...
                    <div v-if="priorityDisplay" class="lg:col-span-2">
                        ...
                        <div class="flex items-center gap-3 p-3 rounded-lg border border-dashed border-gray-300 bg-gray-50 dark:bg-gray-700/40">
                            ...
                            <span class="text-base text-gray-500 dark:text-gray-400">Score: <strong class="text-gray-700 dark:text-gray-200">{{ priorityDisplay.score }}</strong> / 10</span>
                        </div>
                    </div>
                </div>
            </template>
                ...
                <div class="grid grid-cols-1 gap-4 p-4 mb-4 rounded-lg border border-orange-200 bg-orange-50 dark:bg-gray-700/50 dark:border-orange-700 lg:grid-cols-3">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div v-if="record?.priority_level" class="flex items-center gap-3">
                            ...
                            <span class="text-base text-gray-500 dark:text-gray-400">Score: <strong class="text-gray-700 dark:text-gray-200">{{ record.priority_score }}</strong> / 10</span>
                        </div>
                    ...
                    <div>
                        ...
                        <p class="text-base font-medium text-gray-800 dark:text-gray-100">{{ record?.created_at ? new Date(record.created_at).toLocaleString() : '' }}</p>
                    </div>
                    <div>
            ...
            <template v-if="isEdit || hasFullAccess">
                ...
                <div class="grid grid-cols-1 gap-3 p-3 mb-4 border border-dashed border-gray-400 lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select v-model="form.status" class="w-full px-3 py-2 border border-gray-300 rounded-md text-base dark:bg-gray-700 dark:text-white">
                    ...
                    <div v-if="isEdit && record?.responder_attachment">
                        ...
                        <a :href="`/storage/${record.responder_attachment}`" target="_blank" class="text-base text-orange-600 hover:underline">View File</a>
                    </div>
                </div>
            </template>
    ...
    <Modal :show="showMap" max-width="4xl" @close="closeMapModal">
        <div class="p-6">
            ...
            <div class="mt-4 flex justify-end gap-3">
                <button type="button" @click="closeMapModal" class="px-4 py-2 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50">Cancel</button>
                <button type="button" @click="confirmLocation" class="px-4 py-2 text-base font-medium text-white bg-orange-600 rounded-md hover:bg-orange-700">Confirm Location</button>
            </div>
        </div>
    </Modal>
</template>
