...
<head>
    ...
    <style>
        ...
        h3   { text-align: center; font-size: 10px; color: rgba(25, 97, 192, 0.801); }
        h4   { text-align: center; font-size: 14px; color: rgba(25, 97, 192, 0.801); }
        h2   { text-align: center; margin-bottom: 4px; }
        h1, h2, h3, h4, p.sub { margin: 0; padding: 0; line-height: 1.2; }
        p.sub  { text-align: center; margin: 0 0 10px; font-size: 12px; color: #555; }
        p.date { font-size: 12px; margin: 6px 0 4px 0; }
        p.addressee { font-size: 12px; margin: 2px 0; }
        p.salutation { font-size: 12px; margin: 6px 0; }
        p.body-text  { font-size: 12px; text-align: center; margin: 0 0 8px 0; }
        div.baybayin { text-align: center; margin: 0 0 10px 0; }
        table { width: 100%; border-collapse: collapse;}
        th, td { border: 1px solid #444; padding: 3px 3px; text-align: center; vertical-align: middle; }
        th { background-color: #ffce3be0; color: #000; font-size: 8px; }
...
<body>
    ...
    <div class='baybayin'><img src="{{ public_path('storage/img/baybayin.png') }}" style="width:500px; height:20px;" /></div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th rowspan="3" style="border-right: 1px solid #000">BRIEF DESCRIPTION</th>
                </tr>
                <tr >
    ...
    <br><br>
    <p style="font-size:9px;"><strong>Engr.</strong></p>
